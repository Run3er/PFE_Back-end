...
/**
 * Projection of {@link ConstructionSite} dashboard needed data.
 * Optimized for the dashboard as all its needed data is going to be inline.
 */
@Projection(name = "dashboard", types = { ConstructionSite.class })
public interface ConstructionSiteDashboard
{
    String getName();
